...
test('language preferences keep only supported community languages and migrate missing fields', () => {
  ...
  const visibleKeys = ['History', 'Relearning', 'Young', 'Mastery', 'Continue saved session?', 'Resume', 'Start new', 'mature locations', 'until next rank', 'Coverage by continent', 'Study scenes', '1–100 scored rounds · Standard / No Move / NMPZ', 'Major Cities', 'Any environment', 'bestLocationEstimate', 'candidates', 'navLearn', 'navPlay', 'navReview', 'navClues', 'navProgress'];
