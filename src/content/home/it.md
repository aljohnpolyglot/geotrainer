...
Quando non esiste una cronologia idonea, Luoghi familiari e Minore esposizione iniziano dal gruppo selezionato come Casuale. In una ricerca con Minore esposizione e più paesi, GeoTrainer prova prima il paese grigio o meno visitato scelto e il relativo obiettivo regionale. Se quel ciclo non trova un panorama valido, passa agli altri paesi selezionati dal meno al più visitato e ripete il ciclo fino al successo o finché non esci. Un panorama identificato fuori dal paese richiesto fa passare subito al paese successivo. La copertura Street View e i filtri attivi determinano comunque se l’area scelta può fornire un panorama; se il punto esatto non è coperto, può essere usata una vista disponibile nelle vicinanze.
