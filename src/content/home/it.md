...
Quando non esiste una cronologia idonea, Luoghi familiari e Minore esposizione iniziano dal gruppo selezionato come Casuale. In una ricerca con Minore esposizione e più paesi, GeoTrainer prova prima il paese grigio o meno visitato scelto e il relativo obiettivo regionale. Ogni ricerca senza un panorama valido, compreso un panorama fuori dal paese richiesto, passa al paese selezionato successivo dal meno al più visitato. I paesi con la stessa esposizione vengono mescolati, così le ricerche World non attraversano in ordine alfabetico paesi con poca copertura. L’ordine si ripete finché viene trovato un panorama o finché non esci. La copertura Street View e i filtri attivi determinano comunque se l’area scelta può fornire un panorama; se il punto esatto non è coperto, può essere usata una vista disponibile nelle vicinanze.
