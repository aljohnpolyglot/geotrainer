...
Meta elige solo lecciones sin completar. En la configuración, **General** continúa con una lección pendiente al azar, mientras que **Explorar** busca en el catálogo traducido e inicia la lección elegida. Explorar puede mostrar todas, pendientes o completadas; las filas completadas se distinguen visualmente y no se pueden volver a iniciar. Al terminar las 359, su opción de Aprender queda atenuada y ya no puede seleccionarse.
