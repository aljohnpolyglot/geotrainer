...
Consultez lieux, tentatives, temps actif, file, performances et historique. Couverture n’affiche que les panoramas réellement rencontrés. Tapez les premières lettres dans les menus de pays ou catégories pour atteindre une option.

## Synchronisation cloud

Le compte est facultatif et l’entraînement local fonctionne sans connexion. Une fois connecté, le cloud fusionne discrètement la progression compatible entre appareils.
