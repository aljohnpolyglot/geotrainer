...
Quando não há histórico elegível, Locais familiares e Menor exposição começam no conjunto selecionado como Aleatório. Em uma busca de Menor exposição com vários países, o GeoTrainer tenta primeiro o país cinza ou menos visitado escolhido e seu alvo regional. Se esse ciclo não encontrar um panorama válido, ele avança pelos demais países selecionados, da menor para a maior exposição, e repete até conseguir ou até você sair. Um panorama identificado fora do país solicitado avança imediatamente para o próximo país. A cobertura do Street View e os filtros ativos ainda determinam se a área alvo pode fornecer um panorama; uma vista disponível próxima pode ser usada quando o ponto exato não tem cobertura.
