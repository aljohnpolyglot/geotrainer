...
Meta seleciona apenas lições não concluídas. Na configuração, **Geral** continua com uma lição pendente aleatória, enquanto **Explorar** pesquisa o catálogo traduzido e inicia a lição escolhida. Depois que as 359 forem concluídas, a opção em Aprender fica desativada e não pode mais ser escolhida.
