...
Meta Learn selects unfinished lessons only. In setup, **General** continues with a random unfinished lesson, while **Browse** searches the localized catalog and starts the lesson you choose. After all 359 are completed, its Learn option is greyed out and cannot be selected.
