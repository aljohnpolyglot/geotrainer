...
After a text note or pasted-clue analysis is saved, a confirmation identifies it as stored in the Notebook.
...
Meta Learn selects unfinished lessons only. In setup, **General** continues with a random unfinished lesson, while **Browse** searches the localized catalog and starts the lesson you choose. Browse can show all lessons, unfinished lessons, or completed lessons; completed rows are visually marked and cannot be started again. After all 359 are completed, its Learn option is greyed out and cannot be selected.
