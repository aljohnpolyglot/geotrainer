...
Om det inte finns någon möjlig historik börjar Bekanta platser och Minst erfarenhet från det valda urvalet som Slumpmässigt. Vid en sökning med Minst erfarenhet och flera länder provar GeoTrainer först det valda grå eller minst besökta landet och dess regionala mål. Om den sökomgången inte hittar något giltigt panorama går den vidare genom övriga valda länder från minst till mest erfarenhet och upprepar ordningen tills den lyckas eller du lämnar vyn. Street View-täckning och aktiva filter avgör fortfarande om målområdet kan ge ett panorama, så en närliggande tillgänglig vy kan användas när den exakta platsen saknar täckning.
