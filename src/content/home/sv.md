...
Under **Inställningar → AI Coach** väljer du ⚡ Quick Guess, Meta Coach, Elimination Coach, Deep Geography, Memory Coach eller Pro Analyst och separat Kort, Normal eller Djup detaljnivå. Nya profiler frågar efter stil före varje analys; en föredragen stil hoppar över steget. Adaptive och automatiska stilbyten finns inte. Quick Guess är kort; Meta lär ut styrka, roll, tillförlitlighet och förväxlingar; Elimination minskar kandidatfältet; Deep Geography förklarar bara stödda orsaker; Memory skapar sanningsenliga ankare; Pro Analyst väger bevis, motsägelser och informationsvinst. Alla börjar med samma synliga observationer, behandlar procent som AI-uppskattningar och hittar inte på förkortningar, företag, grödor, historia, geologi eller regler.
