...
export function CoverageRegionModal({ countryCode, locations, attempts, reviews, overlay, colors, onClose }: {
  ...
  const naturalEarthMap = countryCode === 'AU' || countryCode === 'CA';
