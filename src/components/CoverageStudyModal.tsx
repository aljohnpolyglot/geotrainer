    ...
    <section className="coverage-study-panel">
      ...
      <div className="coverage-study-view">
        ...
        <div className="panorama-tools coverage-study-tools" aria-label={t('Learning aids')}>
          ...
          <LearningAids lesson={lesson} panoId={location.panoId} countryCode={location.countryCode} reviewActive={false} answerVisible adviceOpen={false} refreshKey={refreshKey} onAdviceClose={() => {}} onSaveClue={saveClue} onNoteSaved={noteSaved} />
        </div>
      </div>
    </section>
  </div>;
