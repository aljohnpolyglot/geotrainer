...
import type { Collection, Environment, LearnPriority, LearnSource, PanoramaSource, SamplingMode, UrbanLevel } from '../types';
...
export type StudySetup = { source: LearnSource; collectionId: string; countryCodes?: string[]; importedMapId?: string; importedMapVariation?: number; environment: Environment; urbanLevel: UrbanLevel; samplingMode: SamplingMode; priority: LearnPriority; panoramaSource: PanoramaSource; allowInteriors: boolean; showCompass: boolean };
