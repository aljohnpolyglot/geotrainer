...
export function AppOverlays(props: AppOverlaysProps) {
  ...
  return <>
    {!showHome && currentLocation && <div className="panorama-tools" aria-label={t('Learning aids')}>
    ...
    {appMode !== 'play' && <LearningAids lesson={appMode === 'study' && learnSource === 'meta' ? studyMeta : reviewMeta}
